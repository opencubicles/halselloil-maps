...
<li class="menu-list map-widget" tooltip-title="Home"><i class="menu-list-icons home-icon"></i></li>
<li class="menu-list map-widget" tooltip-title="Data Filters" @click="showDataFilterModal = true"><i class="menu-list-icons settings-slider-icon"></i></li>
<li class="menu-list map-widget" tooltip-title="Layers" @click="showLayerModal = true"><i class="menu-list-icons layers-icon"></i></li>
<li class="menu-list map-widget" tooltip-title="Exports"><i class="menu-list-icons upload-icon"></i></li>
<li class="menu-list map-widget" tooltip-title="Snapshots"><i class="menu-list-icons camera-icon"></i></li>
<li class="menu-list map-widget" tooltip-title="Tools"><i class="menu-list-icons tools-icon"></i></li>
</ul>
</div>
<transition name="fade" appear>
<div class="" v-if="showDataFilterModal" @click="showDataFilterModal = false"></div>
</transition> 
...
<button class="btn btn-md2 btn-primary data-filter-header-btn pointer-on" id="filter-oil-data" @click="showDataFilterModal = false">Apply</button>
</div>
</div>
...
<transition name="fade" appear>
<div class="" v-if="showLayerModal" @click="showLayerModal = false"></div>
</transition> 
...
<div class="pop-header">
                                ...
                                <div class="header-items-right">
                                    <button class="btn btn-md2 btn-primary data-filter-header-btn pointer-on" id="filter-oil-data" @click="showLayerModal = false">Apply</button>
                                </div>
                            </div>
